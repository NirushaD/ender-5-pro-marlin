...
#define STRING_CONFIG_H_AUTHOR "(Dust baseline; custom E5Pro r3 5x5)"
...
//#define SHOW_CUSTOM_BOOTSCREEN // Omit the extra logo and its startup delay.
...
// Board photo: STM32F103RET6, SD-slot code A (TMC2208 standalone).
...
#define CUSTOM_MACHINE_NAME "Ender-5 Pro r3"
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // Stock mechanical Z endstop; no probe.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, 0 } // Inactive without a probe; no borrowed offsets.
...
//#define Z_AFTER_HOMING 10       // Probe-only in this release; inactive on this stock printer.
...
#define MESH_BED_LEVELING // Stock endstop; manually measured mesh, no probe hardware.
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 // Preserve the user's chosen mesh enable state.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 10          // Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 5    // 25 manually measured points on the stock bed.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
 ...
 */
#define LCD_BED_LEVELING // Guided manual 5x5 mesh on the original knob display.
