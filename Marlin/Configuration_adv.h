 ...
 */
//#define AUTOTEMP // Use the slicer's explicit nozzle temperature, without flow-based autotemp.
#if ENABLED(AUTOTEMP)
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X   0.0        // Disabled until this printer's X resonance is measured.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y   0.0        // Disabled until this printer's Y resonance is measured.
    #define SHAPING_ZETA_Y   0.15       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #define SHAPING_MIN_FREQ  20.0      // Buffer sizing floor; NOT a measured resonance.
  //#define SHAPING_MAX_STEPRATE 10000  // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU                // Calibrate and store without rebuilding.
#endif
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING // Reduce low-step-rate aliasing; upstream adaptive ISR logic.
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define NO_SD_AUTOSTART                   // Start prints explicitly from the menu or host.
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.0 }     // Neutral until calibrated on this printer and filament.
  #else
    #define ADVANCE_K 0.0         // Neutral until calibrated on this printer and filament.
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define ALLOW_LOW_EJERK        // Retain stock E jerk=5; LA may limit acceleration. Tune before raising.
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 // More look-ahead capacity for short-segment SD jobs.
#else
 ...
 */
#define EMERGENCY_PARSER // STM32 UART can recognize emergency commands ahead of the normal queue.
